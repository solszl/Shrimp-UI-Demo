package com.shrimp.demo.panel.camera.core
{
	...
	public final class MyCamera extends EventDispatcher
	{
		...
		private var _updateEvent:CameraEvent;
		...
		public function MyCamera(aStage:Stage, aStageContainer:DisplayObject, aFocusTarget:*, aLayersInfo:Array, aAutoStart:Boolean=false)
		{
			...
			_updateEvent=new CameraEvent(CameraEvent.CAMERA_UPDATE);
		...
		public function update(e:Event=null):void
		{
			...
			//派发更新消息
			if(hasEventListener(CameraEvent.CAMERA_UPDATE))
			{
